        ...
        <div class="card-body p-4 property-form" id="divContent">
            <?= form_open_multipart('Documents/UploadDocuments/Properties/'.$PropertyId, ['id' => 'frmUploadMedia']) ?>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <label class="fw-bold mb-3 fs-5"><i class="fa-regular fa-image me-2 text-primary"></i>Upload Images <span class="text-danger fs-5">(atleast 1 image is required)</span></label>
