        ...
        <div class="card dashboard-card mt-5">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2">
                    <input type="text" id="listingSearch" class="form-control" placeholder="Search by title, type, location..." style="max-width: 200px;">
                    <a href="<?= site_url('Properties/AddListing'); ?>" class="btn btn-primary btn-sm">
                ...
                <div class="row g-4" id="listingsContainer">
                    ...
                    <?php else: ?>
                        <?php foreach ($arrProperties as $key => $value): 
                              $this->load->view('components/property_card', ['value' => $value, 'UserId' => $UserId, 'ShowStatusBadge' => true, 'DashboardLayout' => true]);
                        endforeach; ?>
                    <?php endif; ?>
                </div>
