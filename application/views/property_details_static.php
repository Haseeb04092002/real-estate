        ...
        <div class="container-lg mt-4 mb-5">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4 gap-3">
                <div>
                    ...
                    <h1 class="property-title mb-1">Luxury House in Greenville</h1>
                    <div class="text-muted small">
                        <i class="fa-solid fa-location-dot me-1"></i> Ferris Park, Jersey City, Greenville
                    </div>
                </div>
                <div class="text-md-end">
                    <div class="text-primary-custom fw-bold" style="font-size: 15px;">
                        $1,098 <span class="text-muted fw-normal">/sq ft</span>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-2">
                        ...
                        <div class="swiper mySwiper2" style="height: 500px; border-radius: 4px;">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="<?= base_url('assets/images/property-1.jpg') ?>" class="w-100 h-100" style="object-fit: cover;" alt="Image 1"></div>
                                <div class="swiper-slide"><img src="<?= base_url('assets/images/property-2.jpg') ?>" class="w-100 h-100" style="object-fit: cover;" alt="Image 2"></div>
                                <div class="swiper-slide"><img src="<?= base_url('assets/images/property-3.jpg') ?>" class="w-100 h-100" style="object-fit: cover;" alt="Image 3"></div>
                            </div>
                    ...
                    <div class="swiper mySwiper mb-4" style="height: 90px; cursor: pointer;">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="<?= base_url('assets/images/property-1.jpg') ?>" class="w-100 h-100 rounded-1" style="object-fit: cover;" alt="Thumb 1"></div>
                            <div class="swiper-slide"><img src="<?= base_url('assets/images/property-2.jpg') ?>" class="w-100 h-100 rounded-1" style="object-fit: cover;" alt="Thumb 2"></div>
                            <div class="swiper-slide"><img src="<?= base_url('assets/images/property-3.jpg') ?>" class="w-100 h-100 rounded-1" style="object-fit: cover;" alt="Thumb 3"></div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-2 shadow-sm border mb-4">
                        ...
                        <div class="row text-center g-3">
                            <div class="col">
                                ...
                                <div class="small fw-bold text-dark">September 16, 2025</div>
                            </div>
                            <div class="col">
                                <i class="fa-solid fa-bed fs-3 overview-icon"></i>
                                <div class="fw-bold small text-dark">5 Bedrooms</div>
                            </div>
                            <div class="col">
                                <i class="fa-solid fa-bath fs-3 overview-icon"></i>
                                <div class="fw-bold small text-dark">6 Bathrooms</div>
                            </div>
                            <div class="col">
                                <i class="fa-solid fa-car fs-3 overview-icon"></i>
                                <div class="fw-bold small text-dark">2 Garages</div>
                            </div>
                            <div class="col">
                                <i class="fa-solid fa-vector-square fs-3 overview-icon"></i>
                                <div class="fw-bold small text-dark">190 ft²</div>
                            </div>
                            <div class="col">
                                <i class="fa-regular fa-calendar-days fs-3 overview-icon"></i>
                                <div class="fw-bold small text-dark">Year Built: 2005</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-2 shadow-sm border mb-4">
                        ...
                        <div class="text-muted" style="line-height: 1.8; font-size: 15px;">
                            <p>This property is mostly wooded and sits high on a hilltop overlooking the Mohawk River Valley. Located right in the heart of Upstate NYs Amish farm Country, this land is certified organic making it extremely rare! Good road frontage on a paved county road with utilities make it an amazing setting for your dream country getaway!</p>
                            <p>If you like views, you must see this property! You can see for miles and miles across the valley!</p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="detail-list">
                                    <li><strong>Property ID:</strong> <span>HZ29</span></li>
                                    <li><strong>Price:</strong> <span>$860,000</span></li>
                                    <li><strong>Property Size:</strong> <span>190 ft²</span></li>
                                    <li><strong>Bedrooms:</strong> <span>5</span></li>
                                    <li><strong>Bathrooms:</strong> <span>6</span></li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="detail-list">
                                    ...
                                    <li><strong>Year Built:</strong> <span>2005</span></li>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="accordion_property_address_collapse" class="accordion-collapse collapse show" aria-labelledby="heading_accordion_property_address_collapse">
                                <div class="accordion-body text-muted bg-white rounded-bottom-2 border-top">
                                    <div class="row g-3">
                                        <div class="col-md-4"><strong>Address:</strong> Ferris Park</div>
                                        <div class="col-md-4"><strong>City:</strong> <a href="#" class="text-decoration-none text-primary-custom">Jersey City</a></div>
                                        <div class="col-md-4"><strong>Area:</strong> <a href="#" class="text-decoration-none text-primary-custom">Greenville</a></div>
                                        <div class="col-md-4"><strong>State/County:</strong> <a href="#" class="text-decoration-none text-primary-custom">New Jersey State</a></div>
                                        <div class="col-md-4"><strong>Zip:</strong> 07305</div>
                                        <div class="col-md-4"><strong>Country:</strong> United States</div>
                                        <div class="col-md-12 mt-2">
                                            <a href="https://maps.google.com/?q=Ferris+Park%2CJersey+City" target="_blank" rel="noopener" class="text-primary-custom text-decoration-none fw-bold"><i class="fa-solid fa-map-location-dot me-2"></i>Open In Google Maps</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <button class="accordion-button fw-bold bg-white text-dark rounded-top-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTravelTime" aria-expanded="true" aria-controls="collapseTravelTime">
                                    <div>
                                        ...
                                        <p class="mb-0 text-muted small fw-normal">
                                            From NSW Parliament, Macquarie Street, Sydney NSW, Australia
                                        </p>
                                    </div>
                                </button>
                            </h2>
                                    ...
                                    <form class="p-1 pt-0 mt-0">
                                        ...
                                        <div class="row g-3 mt-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control bg-light border-0 text-muted" value="NSW Parliament, Macquarie Street, Sydney NSW, Australia" readonly="">
                                            </div>
                                        </div>
                    ...
                    <div class="bg-white p-4 rounded-2 shadow-sm border mb-4">
                        ...
                        <div class="ratio ratio-16x9">
                            <video controls class="rounded-2 w-100 h-100" style="object-fit: cover;">
                                <source src="<?= base_url('assets/images/property-video.mp4') ?>" type="video/mp4">
...
I'm interested in [ Luxury House in Greenville ]</textarea>
                            ...
                            <div class="tab-pane fade p-4" id="schedule-tour" role="tabpanel" aria-labelledby="schedule-tour-tab">
                                ...
                                <form>
                                    ...
                                    <textarea class="form-control mb-4 py-2 rounded-1 text-muted bg-light border-0" rows="4">I would like to schedule a tour for [ Luxury House in Greenville ].</textarea>
    ...
    <script>
        ...
        const destLat = -33.8674;
        const destLng = 151.213;
        ...
        function initMap() {
            ...
            const destInfo = new google.maps.InfoWindow({
                content: "<b>Destination</b><br>NSW Parliament, Macquarie Street, Sydney NSW, Australia"
            });
